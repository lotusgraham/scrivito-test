          ...
          <body>
            <div data-collapse="medium" data-animation="default" data-duration={400} className="navbar w-nav">
              <div className="main-menu w-container">
                <div className="mobile-logo-name-div w-hidden-main w-hidden-medium"><a href="#home" className="w-inline-block"><img src="'../../assets/images/abstrakt-concrete-mobile-logo-name.jpg" width={193} alt="Abstrakt Concrete - nav logo - phone" itemprop="logo" className="mobile-image-name" /></a></div><a href="#home" className="mobile-logo-icon w-hidden-main w-hidden-medium w-nav-brand"><img src="../../assets/images/abstrakt-concrete-mobile-logo-icon.jpg" width={58} alt="Abstrakt Concrete - nav symbol - desktop" itemprop="logo" className="mobile-logo-image-icon" /></a><a href="#home" className="logo-nav w-hidden-small w-hidden-tiny w-nav-brand"><img src="../../assets/images/abstrakt-concrete-logo-gold.jpg" width={125} alt="Abstrakt Concrete - nav logo - desktop and ipad" id="home-logo" itemprop="logo" className="home-logo" /></a>
            ...
            <section id="home" className="home-section">
              <div className="home-div"><img src="../../assets/images/abstract-concrete-logo-home.png" width={524} alt="Abstrakt Concrete home logo" sizes="(max-width: 479px) 100vw, (max-width: 767px) 248px, (max-width: 991px) 373px, 524px" srcset="../../assets/images/abstract-concrete-logo-home-p-500x394.png 500w, ../../assets/images/abstract-concrete-logo-home.png 557w" itemprop="logo" className="abstract-concrete-logo-home" /></div>
            </section>
            ...
            <section id="about" className="about-section">
              <div className="about-container w-container">
                ...
                <div className="about-photos-div"><img src="../../assets/images/about-santana-matlock.jpg" width={350} alt="Santana Matlock of Abstrakt Concrete" data-ix="about-pic" className="about-santana-matlock-pic" /><img src="../../assets/images/about-santana-matlock-2.jpg" data-ix="about-pic" className="about-santana-matlock-pic w-hidden-tiny" /></div>
              ...
              <div className="work-container w-container">
                ...
                <div data-animation="fade" data-duration={2000} data-infinite={1} data-delay={3500} data-autoplay={1} className="work-slider w-hidden-small w-hidden-tiny w-slider">
                  <div className="work-slider-mask w-slider-mask">
                    <div className="w-slide"><img src="../../assets/images/slider-inside-santana-matlock-studio-abstrakt-concrete.jpg" alt="Santana Matlock's studio for making custom Nashville, TN concrete products" srcset="../../assets/images/slider-inside-santana-matlock-studio-abstrakt-concrete-p-500x242.jpeg 500w, ../../assets/images/slider-inside-santana-matlock-studio-abstrakt-concrete-p-800x387.jpeg 800w, ../../assets/images/slider-inside-santana-matlock-studio-abstrakt-concrete.jpg 942w" sizes="(max-width: 767px) 100vw, (max-width: 991px) 728px, 940px" /></div>
                    <div className="w-slide"><img src="../../assets/images/slider-guitar-sink-artisan-concrete.jpg" alt="Nashville, TN guitar sink" srcset="../../assets/images/slider-guitar-sink-artisan-concrete-p-500x242.jpeg 500w, ../../assets/images/slider-guitar-sink-artisan-concrete.jpg 942w" sizes="(max-width: 767px) 100vw, (max-width: 991px) 728px, 940px" /></div>
                    <div className="w-slide"><img src="../../assets/images/slider-sink-artisan-concrete.jpg" alt="Abrstrakt Concrete's countertop and sink with truck" srcset="../../assets/images/slider-sink-artisan-concrete-p-500x242.jpeg 500w, ../../assets/images/slider-sink-artisan-concrete-p-800x387.jpeg 800w, ../../assets/images/slider-sink-artisan-concrete.jpg 942w" sizes="(max-width: 767px) 100vw, (max-width: 991px) 728px, 940px" /></div>
                  </div>
                ...
                <div className="work-row w-row">
                  <div className="work-column w-col w-col-4"><a href="#" className="work-lightbox-link w-inline-block w-lightbox"><img src="../../assets/images/guitar-sink.jpg" alt="guitar sink - perfect for Nashville, TN" className="work-image" /></a></div>
                  <div className="work-column w-col w-col-4"><a href="#" className="work-lightbox-link w-inline-block w-lightbox"><img src="../../assets/images/artisan-sink-3.jpg" alt="gorgeous sink modeled in front of an old truck" className="work-image" /></a></div>
                  <div className="work-column w-col w-col-4"><a href="#" className="work-lightbox-link w-inline-block w-lightbox"><img src="../../assets/images/Japanese-garden-fire-pit.jpg" alt="beautiful custom fire pit" className="work-image" /></a></div>
                </div>
                <div className="work-row w-row">
                  <div className="work-column w-col w-col-4"><a href="#" className="work-lightbox-link w-inline-block w-lightbox"><img src="../../assets/images/antique-wood-sink.jpg" alt="antique bathroom sink" className="work-image" /></a></div>
                  <div className="work-column w-col w-col-4"><a href="#" className="work-lightbox-link w-inline-block w-lightbox"><img src="../../assets/images/concrete-planter.jpg" className="work-image" /></a></div>
                  <div className="work-column w-col w-col-4"><a href="#" className="work-lightbox-link w-inline-block w-lightbox"><img src="../../assets/images/art-deco-sink.jpg" alt="Santana Matlock's custom bathroom sink " className="work-image" /></a></div>
                </div>
                <div className="work-row w-row">
                  <div className="work-column w-col w-col-4"><a href="#" className="work-lightbox-link w-inline-block w-lightbox"><img src="../../assets/images/custom-marbled-artisan-sink.jpg" alt="marble stained concrete sink" className="work-image" /></a></div>
                  <div className="work-column w-col w-col-4"><a href="#" className="work-lightbox-link w-inline-block w-lightbox"><img src="../../assets/images/porch-sculpture-concrete-fire-pit.jpg" alt="Beautiful concrete fire pit" className="work-image" /></a></div>
                  <div className="work-column w-col w-col-4"><a href="#" className="work-lightbox-link w-inline-block w-lightbox"><img src="../../assets/images/concrete-light-socket.jpg" alt="concrete light sink" className="work-image" /></a></div>
                </div>
                <div className="work-row w-row">
                  <div className="work-column w-col w-col-4"><a href="#" className="work-lightbox-link w-inline-block w-lightbox"><img src="../../assets/images/artisan-sink-2.jpg" alt="handcrafted artisan sink made from concrete" className="work-image" /></a></div>
                  <div className="work-column w-col w-col-4"><a href="#" className="work-lightbox-link w-inline-block w-lightbox"><img src="../../assets/images/concrete-bike-table.jpg" alt="table made from a bike" className="work-image" /></a></div>
                  <div className="work-column w-col w-col-4"><a href="#" className="work-lightbox-link w-inline-block w-lightbox"><img src="../../assets/images/dog-bone-drinking-fountain.jpg" alt="custom concrete dog bone birdbath" className="work-image" /></a></div>
                </div>
                <div className="work-row w-row">
                  <div className="work-column w-col w-col-4"><a href="#" className="work-lightbox-link w-inline-block w-lightbox"><img src="../../assets/images/long-grey-concrete-sink.jpg" alt="custom long grey sink" className="work-image" /></a></div>
                  <div className="work-column w-col w-col-4"><a href="#" className="work-lightbox-link w-inline-block w-lightbox"><img src="../../assets/images/artisan-concrete-sink-and-couch.jpg" alt="concrete sink and couch" className="work-image" /></a></div>
                  <div className="work-column w-col w-col-4"><a href="#" className="work-lightbox-link w-inline-block w-lightbox"><img src="../../assets/images/artisan-concrete-sink-1.jpg" alt="custom concrete sink with artsy wall" className="work-image" /></a></div>
                </div>
                <div className="work-row w-row">
                  <div className="work-column w-col w-col-4"><a href="#" className="work-lightbox-link w-inline-block w-lightbox"><img src="../../assets/images/artisan-sink-4.jpg" alt="sink with custom drain" className="work-image" /></a></div>
                  <div className="work-column w-col w-col-4"><a href="#" className="work-lightbox-link w-inline-block w-lightbox"><img src="../../assets/images/black-and-gold-sink.jpg" alt="black and gold sink" className="work-image" /></a></div>
                  <div className="work-column w-col w-col-4"><a href="#" className="work-lightbox-link w-inline-block w-lightbox"><img src="../../assets/images/handcrafted-wood-table-concrete.jpg" alt="handmade custom coffee table" className="work-image" /></a></div>
                </div>
              </div>
            </section>
            ...
            <section id="Santana-Matlock-in-the-news" className="abstrakt-concrete-media">
              <div className="news-container w-container">
                ...
                <div className="news-diy-logo-columns w-row">
                  <div className="w-col w-col-6"><img src="../../assets/images/diy-logo.png" width={477} data-ix="about-paragraph" alt="DIY Network logo" className="news-diy-logo" /></div>
                  <div className="news-columns w-col w-col-6"><img src="../../assets/images/flip-nashville-graphic.png" data-ix="about-paragraph" alt="Nashville Flipped - DIY Network logo" width={269} className="news-diy-logo" /></div>
                </div>
              ...
              <div className="contact-section-container w-container">
                ...
                <div className="contact-row w-row">
                  <div className="work-column-1 w-clearfix w-col w-col-5">
                    <div className="contact-info-line-div w-clearfix"><a href="tel:1-615-743-5552" className="contact-icon-link w-inline-block"><img src="../../assets/images/phone-abstrakt-concrete-contact.png" width={33} alt="Abstrakt Concrete - phone icon" className="contact-field-image" /></a>
                    ...
                    <div className="contact-info-line-div w-clearfix"><a href="#" className="contact-icon-link w-inline-block w-clearfix"><img src="../../assets/images/location-abstrakt-concrete-contact.png" width={33} alt="Abstrakt Concrete - address icon" className="contact-field-image" /></a>
            ...
            <section className="footer-section">
              <div className="footer-main-div"><img src="../../assets/images/Abstrakt-Concrete-Made-in-Nashville.png" alt="Made in Nashville" className="footer-made-in-nashville-pic" />
              ...
              <div className="footer-designed-by">
                <a href="https://www.flowglobe.io/" target="_blank" data-ix="footer-designed-by-animate" className="footer-designed-by-link-block w-inline-block">
                  <div className="footer-designed-by-text">Website designed and developed by</div><img src="../../assets/images/flow-globe-media-header-icon.png" width={274} className="footer-designed-by-graphic" /></a>
              </div>
            </section>
          </body>
        </div>
